...
library(vcfR, lib.loc="/hpcshare/genomics/bin/consensus_SV_script/libraryR/")
library(splitstackshape) #, lib.loc="/hpcshare/genomics/bin/consensus_SV_script/libraryR/")
library(abind) #, lib.loc="/hpcshare/genomics/bin/consensus_SV_script/libraryR/")
library(reshape2) #, lib.loc="/hpcshare/genomics/bin/consensus_SV_script/libraryR/")
